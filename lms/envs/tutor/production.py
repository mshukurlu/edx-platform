...
# CMS authentication
IDA_LOGOUT_URI_LIST.append("http://studio.tehsilim.edu.az/complete/logout")

# Required to display all courses on start page
SEARCH_SKIP_ENROLLMENT_START_DATE_FILTERING = True


ACCOUNT_MICROFRONTEND_URL = "http://apps.tehsilim.edu.az/account"


WRITABLE_GRADEBOOK_URL = "http://apps.tehsilim.edu.az/gradebook"


LEARNING_MICROFRONTEND_URL = "http://apps.tehsilim.edu.az/learning"


PROFILE_MICROFRONTEND_URL = "http://apps.tehsilim.edu.az/profile/u/"


LOGIN_REDIRECT_WHITELIST.append("apps.tehsilim.edu.az")
CORS_ORIGIN_WHITELIST.append("http://apps.tehsilim.edu.az")
CSRF_TRUSTED_ORIGINS.append("apps.tehsilim.edu.az")